...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/napari-zelda-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15344&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/napari-zelda-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `napari-zelda` can be installed with:

```
conda install napari-zelda
```

It is possible to list all of the versions of `napari-zelda` available on your platform with:
